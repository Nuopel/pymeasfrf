...
from toolkitsd.math import math_func as tool
...
if test == True :
    ...
    y = recsig.record_frf_1spk_2_1mic(mic2record=0,spk2record=0,sig2play = sig.x,gain = 0.5, FS = fs ,path2save_record=path2save_record , opt_plot = 0 )
